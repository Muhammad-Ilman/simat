...
var TemplateHeader = $('.navbar-top');
var PageContentWrapper = $(".page-content-wrapper");
var DesktopToggler = $(".navbar-top-desk-toggler");
var MobileToggler = $(".navbar-top-mobile-toggler");
  ...
  if (bannerState == "enabled") {
    ...
    $("body").prepend('\
          <div class= "item-purchase-banner">\
            <p class="font-weight-medium banner-text">Sistem Informasi dan Manajemen Surat - <span class="font-weight-bold text-warning">SIMAT APPLICATION</span></p>\
              <!--<a href = "https://wa.me/p/3655759331189129/6285797443848" target = "_blank" class = "banner-button btn btn-primary btn-icon" > \
                <i class="mdi mdi-cart mr-2"></i>Buy Now\
              </a>-->\
              <span class="toggler-close"><i class="bx bx-x"></i></span>\
          </div>\
        ')
...
const sidebarLink = document.querySelectorAll('.sidebar-link')
	...
	function change(){
    	if(sidebarLink){
        	sidebarLink.forEach(l=> l.classList.remove('sidebar-link-active'))
        	this.classList.add('sidebar-link-active')
    }
	}
	sidebarLink.forEach(l=> l.addEventListener('click', change))