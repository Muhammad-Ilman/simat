...
<div class="col-lg-12">
            ...
            <?php if(session()->getFlashData('suratkeluar')) : ?>
                <div class="alert alert-info mt-2 mb-1" role="alert">
					<div class="d-flex">
                    	<p><?= session()->getFlashData('suratkeluar');?></p>
            ...
            <?php endif ?>
                <p style="font-size: 9px">Manage data disini !</p>
                  ...
                  <div class="mt-4 mb-4 ml-4 mr-4">
                      <a href="<?= base_url('suratkeluar/create'); ?>" class="btn btn-info mt-3 mb-3"><i class='bx bx-plus'></i> Surat Baru</a>
                      <a href="<?= base_url('suratkeluar/history'); ?>" class="btn btn-secondary mt-3 mb-3"><i class='bx bx-history'></i> History</a>
                    <div class="table-responsive">
                      <table class="table table-hover mt-4 mb-4" id="table-surat">
                        ...
                        <?php $i = 1; foreach ( $suratkeluar as $sm ) : ?>
                      ...
                      <?php endif; ?>
                            ...
                            <td class="d-flex align-items-center border-top-0">
                              ...
                              <a href="<?= base_url('/suratkeluar/'.$sm['sm_slug']);?>" class="text-dark"><?= $sm['sm_nama'];?></a>
                            ...
                            <td><?= $sm['perihal'] ;?></td>
                            <td><i class="text-dark">@</i><?= $sm['pengirim'] ;?></td>                        
                            <td><?= $sm['in_nama']?></td>
                            <td class="actions">
                              <div class="btn-group">
                            	<div class="actions-print-download">
									<a href="<?= base_url('suratkeluar/print/'. $sm['sm_slug']); ?>" class="btn btn-rounded social-icon-btn btn-inverse-info"><i class='bx bxs-printer bx-tada' > </i></a>
									<a href="<?= base_url('suratkeluar/download/'. $sm['sm_slug']); ?>" class="btn btn-rounded social-icon-btn btn-inverse-success"><i class='bx bxs-download bx-fade-up' ></i></a>
		                        ...
		                        <div class="dropdown-menu dropdown-menu-right">
		                          <a class="dropdown-item" href="<?= base_url('/suratkeluar/'.$sm['sm_slug']);?>">Detail</a>
		                          <a class="dropdown-item" href="<?= base_url('/suratkeluar/update/'.$sm['sm_slug']);?>">Edit</a>
		                        </div>
		                      </div>
                            </td>
                          </tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#trash', function() {
               ...
               $('#slug_url').attr('href', '<?= base_url('suratkeluar/trash');?>/'+link);
            })
        } );
    </script>
<? $this->endSection();?>