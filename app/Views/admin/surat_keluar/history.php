                            ...
                            <td class="actions">
                              <div class="btn-group">
                            	<div class="actions-print-download">
									<a href="<?= base_url('suratkeluar/restore/'. $sm['sm_slug']); ?>" class="btn btn-rounded social-icon-btn btn-inverse-info"><i class='bx bxs-archive-out bx-tada' ></i></a>
								 <form action="<?= base_url('/suratkeluar/del/'.$sm['sm_slug']); ?>" method="post" class="d-inline">
                                <?= csrf_field() ?>
